...
class Course(models.Model):
    ...
    hero_image = models.ImageField(
        verbose_name=_("Course image"), upload_to="courses", null=True, blank=True
    )
...
class Question(models.Model):
    ...
    text = models.CharField(
        max_length=1000, verbose_name=_("Questions"), null=True, blank=True
    )
...
class Answer(models.Model):
    ...
    text = models.CharField(max_length=1000, verbose_name=_("Answer to Question"))
...
class UserResponse(models.Model):
    user = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="userresponse"
    )
    question = models.ForeignKey(
        Question, related_name="user_response_question", on_delete=models.CASCADE
    )
    response = models.ForeignKey(
        Answer,
        on_delete=models.DO_NOTHING,
        related_name="response_answer",
        verbose_name=_("Your response"),
    )
